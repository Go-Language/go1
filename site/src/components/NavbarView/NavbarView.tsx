...
const NavItems: React.FC<React.PropsWithChildren<{ className?: string; linkClassName?: string }>> = ({ className }) => {
...
export const NavbarView: React.FC<React.PropsWithChildren<NavbarViewProps>> = ({ user, onSignOut }) => {
  const styles = useStyles()
